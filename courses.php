                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=HTML Course for Beginners&price=0">
    Enroll Now
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Front End Development-CSS&price=199">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>2.5
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Introduction to JavaScript&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Python Programming&price=299">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>5.0
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=SQL for Data Science&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>4.5
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=ChatGPT for Beginners&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>3.0
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=AWS for Beginners&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Microsoft Azure Essentials&price=299">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>3.5
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Introduction to MS Excel&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>2.5
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 299</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Statistics for Data Science&price=299">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                    ...
                    <div class="course-item shadow">
                        ...
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>2.0
                                Hrs</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="payment.php?course=Java Programming&price=0">
    Enroll Now
</a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="index.php">Secret Coder</a>, All Right Reserved.
